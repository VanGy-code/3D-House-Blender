...
class BlenderInterface():
    def __init__(self, resolution=128, background_color=(1,1,1)):
        ...
        utils.set_camera_focal_length_in_world_units(self.camera.data, 525./512*resolution) # Set focal length to a common value (kinect)
    ...
    def render(self, output_dir, blender_cam2world_matrices, write_cam_params=False):
        ...
        if write_cam_params:
            ...
            utils.cond_mkdir(img_dir)
            utils.cond_mkdir(pose_dir)
        else:
            img_dir = output_dir
            utils.cond_mkdir(img_dir)
        ...
        for i in range(len(blender_cam2world_matrices)):
            ...
            if write_cam_params:
                ...
                RT = utils.get_world2cam_from_blender_cam(self.camera)
